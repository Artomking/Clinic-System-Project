...
void addAppointment(struct Appointment* apppointment, int, struct Patient* patient, int);


// Remove an appointment record from the appointment array
void removeAppointment(struct Appointment* appointment, int, struct Patient* patient, int);
...
void sortAppointments(struct Appointment app[], int);
